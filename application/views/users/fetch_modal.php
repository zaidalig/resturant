<table style="border: 0px solid #000;" width="100%">
    ...
    <tr>
        <td class="txtwhite border-btm" colspan="2"><?php echo $table_disp; ?></td>
        <td class="txtwhite "></td>
        <td class="txtwhite border-btm" colspan="2"><?php echo $hut_disp; ?></td>
    </tr>
    <tr>
...
<div class="btn-group btn-block">
    <input type ="submit" class="btn btn-danger btn-md" style="width:50%" name="cancel" value ="Cancel">
    <input type ="submit" class="btn btn-primary btn-md" style="width:50%" name="save" value ="Save">
</div>